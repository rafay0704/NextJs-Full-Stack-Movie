                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        ...
                        <div className={footerStyles[`media-icons`]}>
                            ...
                            <Link href="https://instagram.com/rafay0704?igshid=ZDc4ODBmNjlmNQ==" target="_blank"><i > <FaInstagram/>  </i></Link>
                            <Link href="https://www.linkedin.com/in/abdul-rafay-ab3ba0170" target="_blank"><i > <FaLinkedinIn /> </i></Link>
                ...
                <div className={footerStyles['bottom-details']}>
                    <div className={footerStyles.bottom_text}>
                        <span className={footerStyles.copyright_text}> Copyright © 2023
                            <Link href="/>"> Abdul Rafay.</Link> All rights reserved </span>
